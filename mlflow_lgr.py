...
if __name__ == '__main__':
    ...
    mlflow.set_experiment(experiment_name = 'mlflow logisticRegression model')
    ...
    train_accuracy = lrmodel.score(X_train, y_train)  ## performance on train data
    test_accuracy = lrmodel.score(X_test, y_test)  ## performance on test data

    log_metric("Accuracy for this run", test_accuracy)

    ## log_metric("Accuracy for this run", test_accuracy)
    mlflow.sklearn.log_model(lrmodel, "LogisticRegression")
